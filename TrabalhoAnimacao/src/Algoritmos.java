...
public class Algoritmos {
    ...
    /*public void animacao(JLabel area,Esfera lua, Esfera terra){
    	BufferedImage img;
		for(int i=0;i<50;i++){
			img = criaImagem(450, 300);
			desenhaCirculoBresenham(img, terra.x, terra.y, terra.raio);
			desenhaCirculoBresenham(img, lua.x+i, lua.y, lua.raio);
